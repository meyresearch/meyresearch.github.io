...
- _Vision/Survey_: 
  ...
  - [arxiv'23^a] [TransNFV: Integrating Transactional Semantics for Efficient State Management in Virtual Network Functions](https://arxiv.org/pdf/2307.10732.pdf)
...
- _Algorithm/Query Optimization_: 
  ...
  - [ICDE'23^b] [Scalable Online Interval Join on Modern Multicore Processors in OpenMLDB](https://intellistream.github.io/downloads/papers/Zhang-2023-OIJ-OpenMLDB_CR.pdf) 
...
- _System Development/Optimization_:
  ...
  - [arxiv'23] [CStream: Parallel Data Stream Compression on Multicore Edge Devices -- Journal Extension](https://arxiv.org/pdf/2306.10228.pdf)
  ...
  - [arxiv'23] [MorphStream: Scalable Processing of Transactions over Streams on Multicores - Journal Extension](https://arxiv.org/pdf/2307.12749.pdf)
  - [ICDE'23] [CompressStreamDB: Fine-Grained Adaptive Stream Processing without Decompression](https://ieeexplore.ieee.org/document/10184565/) lead by Prof.Feng Zhang (Renmin University of China)
  - [ICDE'20] [Towards Concurrent Stateful Stream Processing on Multicore Processors](https://doi.org/10.1109/ICDE48307.2020.00136)
  - [TPDS'21] [Fine-Grained Multi-Query Stream Processing on Integrated Architectures](https://doi.org/10.1109/TPDS.2021.3066407) lead by Prof.Feng Zhang (Renmin University of China)
  - [USENIX ATC'20] [FineStream: Fine-Grained Window-Based Stream Processing on CPU-GPU Integrated Architectures](https://www.comp.nus.edu.sg/~hebs/pub/atc20-finestream.pdf) lead by Prof.Feng Zhang (Renmin University of China)
  ...
  - [TPDS'17] [Understanding Co-Running Behaviors on Integrated CPU/GPU Architectures](https://doi.org/10.1109/TPDS.2016.2586074) lead by Prof.Feng Zhang (Renmin University of China)
  - [SC'16] <a href="https://ieeexplore.ieee.org/document/7877153">Elastic Multi-resource Fairness: Balancing Fairness and Efficiency in Coupled CPU-GPU Architectures</a> lead by Prof.Shanjiang Tang (Tianjin University)
  - [TPDS'16] <a href="https://wangzeke.github.io/doc/melia-tpds-16.pdf">Melia: A MapReduce Framework on OpenCL-Based FPGAs</a> lead by Prof.Zeke Wang (Zhejiang University)
  - [MASCOTS'15] [To Co-run, or Not to Co-run: A Performance Study on Integrated Architectures](https://doi.org/10.1109/MASCOTS.2015.27) lead by Prof.Feng Zhang (Renmin University of China)
...
- _Vision/Survey_:
  - [arxiv'23] [Harnessing Scalable Transactional Stream Processing for Managing Large Language Models [Vision]](https://arxiv.org/pdf/2307.08225.pdf)

- _Benchmarking_:
  - [arxiv'24] [Online Continual Knowledge Learning for Language Models](https://arxiv.org/abs/2311.09632)
  ...
  - [reviewing] Benchmarking of Approximating Matrix Multiplication on Modern Hardware
  
- _Algorithm/Query Optimization_:
  - [arxiv'23^a] [Self-Optimizing Data Stream Clustering Algorithm(https://arxiv.org/abs/2309.04799)
- _System Development/Optimization_:
  - [SIGMOD'24] [Predictive and Near-Optimal Sampling for View Materialization in Video Databases](), lead by Prof.Dongxiang Zhang (Zhejiang University)
  - [preparing] [Novel Retrival Paradigam/Algorithm for Large Language Models]() lead by Prof.Wei Lu (SUTD)
  ...
  - [IJCAI'20, TKDE'21, VLDBJ'22] <a href="https://www.ijcai.org/proceedings/2020/610">Parking Prediction</a> by Prof.Feng Zhang (Renmin Univeristy of China)
  - [arxiv'22] [A Framework for Fast Polarity Labelling of Massive Data Streams](https://arxiv.org/abs/2203.12368)
